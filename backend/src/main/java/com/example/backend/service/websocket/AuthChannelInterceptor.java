...
//            final String password = accessor.getFirstNativeHeader(PASSWORD_HEADER);
            ...
            final String jwt = accessor.getFirstNativeHeader("access-token");
//            final String jwtRefresh = accessor.getFirstNativeHeader("refresh-token");

            // authenticate the user and if that's successful add their user information to the headers.
//            UsernamePasswordAuthenticationToken user = service.getAuthenticatedOrFail(jwt, jwtRefresh);
            UsernamePasswordAuthenticationToken user = service.getAuthenticatedOrFail(jwt);
